...
def prepare_fingerprints_delaney(dataset_name):
    target_name = dataset_name
    whole_data_pd = pd.read_csv('../train_{}.csv'.format(dataset_name))
    ...
    data_pd.to_csv('{}/{}.csv.gz'.format(dataset_name, i), compression='gzip', index=None)
    return


if __name__ == '__main__':
    dataset_name = 'lipo'
    prepare_fingerprints_delaney(dataset_name)
