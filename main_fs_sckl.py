...
from data_scaffold_fs import GetData, GetValData, GetTestData
...
parser.add_argument('--alpha', type=float, default=0.3, metavar='N',
...
parser.add_argument('--outf', type=str, default='freesolv/logs', metavar='N',
...
if __name__ == "__main__":
    ...
    best_result = 1000
    res = {'epochs': [], 'train_loss': [], 'val_loss': [], 'best_val': 1e10, 'best_test': 1e10, 'best_epoch': 0}
